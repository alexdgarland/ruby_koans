...
class AboutClassMethods < Neo::Koan
  ...
  #   - The second one seems to be convenient if you are defining multiple class methods within a kind of a block.
  #   - The first may be clearer if you are only defining one class method.  
