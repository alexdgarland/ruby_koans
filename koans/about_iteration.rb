...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #  - Functional fold - apply a binary combination operation over (current accumulator, next element), with a starting element supplied to bootstrap the initial value of the accumulator
  end
  ...
  #   # code to read 'file'
  #
  #  - basically the same as Python context managers - holds a finite or expensive resource (in this case OS file handle) only for the duration of the do block.
  #
