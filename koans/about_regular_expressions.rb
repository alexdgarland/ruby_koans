...
class AboutRegularExpressions < Neo::Koan
  ...
  #   - character class matches any character from a set of individual characters,
  #     the alternation matches specific sequences of characters from a set of sequences
