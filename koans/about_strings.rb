...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #   - so that multiple new strings aren't built up in memory as it iterates
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised? - no, it's zero-based indexing, as with arrays (strings are on some level just char arrays, although wrapped/ managed)
  end
